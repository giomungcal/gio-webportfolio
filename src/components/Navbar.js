...
const Navbar = () => {
    return (
        <div className="header" id="nav">
            ...
            {/* <a href="#"><img className="header__hamburger hide-desktop hide-mobile" src={hamburger} alt="hamburger"/></a> */}
            <ul className="header__list show-desktop hide-mobile">
                <li className="hide-desktop"><a href="#home">X</a></li>
                <li className="header__link header__link--active"><a href="#nav">home</a></li>
